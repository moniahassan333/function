...
<div class="container fade" id="loginDiv">
  <form autocomplete="off" onsubmit="return false;">
    ...
    <div class="input-group">
      ...
      <span class="toggle-pass" onclick="togglePassword('loginPass', this)">👁️</span>
    </div>
...
<div class="container fade" id="registerDiv" style="display:none">
  <form autocomplete="off" onsubmit="return false;">
    ...
    <div class="input-group">
      ...
      <span class="toggle-pass" onclick="togglePassword('regPass', this)">👁️</span>
    </div>
    <div class="input-group">
      <input type="password" id="regConfirm" placeholder="تأكيد كلمة المرور" autocomplete="new-password">
      <span class="toggle-pass" onclick="togglePassword('regConfirm', this)">👁️</span>
    </div>
